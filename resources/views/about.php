...
<div class="text-center py-5">
    ...
    <p class="lead text-muted max-w-2xl mx-auto">
        Framework ini tuh proyek MVC ringan yang dibikin fokus buat belajar konsep inti PHP modern. Alih-alih pakai abstraksi ribet yang susah di-maintain, di sini semuanya dibikin simpel dan gampang dipahamin.
    </p>
    <div class="mt-5 row text-start justify-content-center">
        <div class="col-md-4 mb-4">
            <div class="p-4 bg-white rounded shadow-sm h-100 border">
                ...
                <p class="text-muted small">Fitur routing dasar buat nyambungin URL langsung ke method controller atau closure dengan gampang dan santai.</p>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="p-4 bg-white rounded shadow-sm h-100 border">
                ...
                <p class="text-muted small">Punya struktur Model-View-Controller yang lurus-lurus aja buat ngebantu pisahin dan ngerapiihin logika aplikasimu.</p>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="p-4 bg-white rounded shadow-sm h-100 border">
                ...
                <p class="text-muted small">Udah disediain mesin bahasa template dasar ala Blade buat bikin HTML dinamis jadi lebih enak diliat dan bersih.</p>
            </div>
        </div>
    </div>
</div>
